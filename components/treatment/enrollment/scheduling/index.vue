      ...
      <center>
        ...
        <a-row style="display: flex; align-items: center;">
          <a-col :span="15">
            ...
            <a-row class="row-height"><a-col :span="10"><strong>Container Date:</strong></a-col><a-col :span="14">{{ _getFormatMoment(getMomentByStandardFormat(collectionDate)).format('DD MMMM YYYY') +' '+ collectionTime }}</a-col></a-row>
          </a-col>
          <a-col :span="9" >
    ...
    onSubmit(e) {
      ...
      this.form.validateFields((err, values) => {
        if (!err) {
          ...
          this.collectionTime = values.time

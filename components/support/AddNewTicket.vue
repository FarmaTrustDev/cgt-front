<template>
  <div>
    <a-modal v-model="visible" title="Add New Ticket" @ok="handleOk" :afterClose="handleCancel" :footer="null">
  ...
  export default{
    data() {
      return {
        ...
        stakholdersList : [{'id': 1, 'name' : 'Hospita'},{'id' :2, 'name': 'Other'},{'id': 3, 'name': 'Other'}],
      }
    },
    methods: {
      showModal() {

<template>
  <div>
    <a-button type="primary" @click="goto('/superAdmin/entities/addManufacturer/form')">+ Add manufacturer</a-button>
    <a-table :columns="columns" :data-source="manufacturer">
...
export default {
  ...
  methods: {
    preventDefault,
    fetch() {
      OrganizationServices.get({ organizationTypeId: 3 }).then((response) => {

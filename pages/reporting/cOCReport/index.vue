<template>
      ...
      <template slot="content">
        <a-card style="margin-top: -80px;">
            ...
            <a-col :offset="4" :span="10" class="report-head">
               <h3 class="ml-10">Collection Date: {{ _getFormatMoment(sampleData.collectionDate).format("DD/MM/YYYY")  }}</h3>  
            </a-col>
            ...
            <a-col :offset="8" :span="8" class="mt-20"><h3>Report Generated On: {{_getFormatMoment(sampleData.createdAt).format("DD/MM/YYYY") }}</h3></a-col>
        ...
        <a-col :offset="19" :span="2" class="mt-20">
                ...
                type="primary"
                @click="submitCOC(sampleData.id,'Released')"
                >QP Release</a-button
                >
                </div>
        </a-col>
  ...
  export default {
    ...
    methods: {
      ...
      submitCOC(cocId,status)
      {
        COCReportServices.submitCOC(cocId,status).then((response)=>{
